...
public class BlueMacawOnEntityTickUpdateProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		new Object() {
			...
			private void run() {
				if (entity.getPersistentData().getDouble("FeedType") == 1) {
				...
				} else if (entity.getPersistentData().getDouble("FeedType") == 2) {
					if (world instanceof Level _level && !_level.isClientSide()) {
				...
				} else if (entity.getPersistentData().getDouble("FeedType") == 3) {
					if (world instanceof Level _level && !_level.isClientSide()) {
				...
				} else if (entity.getPersistentData().getDouble("FeedType") == 4) {
					if (world instanceof Level _level && !_level.isClientSide()) {
				...
				entity.getPersistentData().putDouble("FeedType", 0);
