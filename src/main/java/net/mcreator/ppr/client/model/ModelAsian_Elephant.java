...
public class ModelAsian_Elephant<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ppr", "model_asian_elephant"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 92).addBox(-5.8573F, -1.9796F, -21.6874F, 11.0F, 18.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.8573F, -11.0204F, -9.3126F));
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -5.5F, -5.85F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(71, 0)
		...
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(60, 51).addBox(4.0F, -1.0F, -9.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.01F)).texOffs(33, 92)
		...
		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 121).addBox(-9.0F, -9.0F, 0.5F, 18.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(16.4326F, -1.9796F, -6.489F, 0.0F, -0.48F, 0.0F));
		PartDefinition cube_r4 = Head.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(112, 67).addBox(-38.0F, -9.0F, -14.5F, 18.0F, 18.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(16.4326F, -1.9796F, -6.489F, 0.0F, 0.48F, 0.0F));
		PartDefinition cube_r5 = Head.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(58, 74).addBox(-9.0F, -9.0F, -10.0F, 18.0F, 18.0F, 18.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.1427F, -1.8277F, -8.951F, -0.0873F, 0.0F, 0.0F));
		PartDefinition cube_r6 = Head.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(132, 0).addBox(-3.5F, -9.8F, 0.8F, 7.0F, 18.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = Head.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(130, 86).addBox(-2.5F, -11.75F, 2.25F, 5.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3573F, 36.2163F, -3.3193F, 1.0472F, 0.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -16.9935F, 12.0742F, 22.0F, 24.0F, 27.0F, new CubeDeformation(0.01F)),
				PartPose.offset(2.0F, -3.0F, -20.0F));
		PartDefinition cube_r8 = Body.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(85, 38).addBox(-9.0F, -5.5F, -9.75F, 18.0F, 16.0F, 13.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -8.4935F, 16.8242F, -0.4363F, 0.0F, 0.0F));
		PartDefinition cube_r9 = Body.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 51).addBox(-11.0F, -7.0F, -14.2F, 22.0F, 25.0F, 16.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeg1 = partdefinition.addOrReplaceChild("LeftLeg1",
				CubeListBuilder.create().texOffs(112, 110).addBox(-4.5F, -1.0F, -4.0F, 9.0F, 20.0F, 8.0F, new CubeDeformation(0.01F)),
				PartPose.offset(8.5F, 5.0065F, -3.9258F));
		PartDefinition RightLeg1 = partdefinition.addOrReplaceChild("RightLeg1",
				CubeListBuilder.create().texOffs(78, 110).addBox(-4.5F, 1.0F, -4.0F, 9.0F, 20.0F, 8.0F, new CubeDeformation(0.01F)),
				PartPose.offset(-4.5F, 3.0065F, -3.9258F));
		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2",
				CubeListBuilder.create().texOffs(98, 0).addBox(-4.5F, -2.0F, -4.0F, 9.0F, 20.0F, 8.0F, new CubeDeformation(0.01F)),
				PartPose.offset(8.5F, 6.0065F, 23.0742F));
		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2",
				CubeListBuilder.create().texOffs(44, 110).addBox(-4.5F, 0.0F, -4.0F, 9.0F, 20.0F, 8.0F, new CubeDeformation(0.01F)),
