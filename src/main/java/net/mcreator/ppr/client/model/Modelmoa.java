...
public class Modelmoa<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ppr", "modelmoa"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 20).addBox(-3.0F, -7.5F, -8.5F, 6.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.5F, -4.5F));
		PartDefinition Body = partdefinition.addOrReplaceChild(
				"Body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.5F, 9.25F, 10.0F, 9.0F, 11.0F, new CubeDeformation(0.0F))
						.texOffs(0, 38).addBox(0.0F, -3.5F, 4.25F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.5F, 3.5F, -11.0F));
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(14, 20).addBox(-4.0F, -2.1F, -4.5F, 8.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 0.5F, 24.75F, 0.48F, 0.0F, 0.0F));
		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(29, 33).addBox(-3.0F, -3.0F, -4.5F, 6.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 3.5F, 10.75F, -0.3054F, 0.0F, 0.0F));
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 26).addBox(-1.0F, 10.5319F, -6.7937F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 6)
		...
		PartDefinition cube_r3 = LeftLeg.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, -6.0F, 0.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = LeftLeg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(39, 16).addBox(-1.5F, -4.5F, -4.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 5.169F, 0.737F, -0.4363F, 0.0F, 0.0F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(16, 38).addBox(-1.0F, 9.5319F, -2.7937F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.1F)).texOffs(12, 35)
		...
		PartDefinition cube_r5 = RightLeg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -6.0F, 0.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = RightLeg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(31, 0).addBox(-6.5F, -4.5F, -4.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
