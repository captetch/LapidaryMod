...
public class Modelcamel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("ppr", "modelcamel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(28, 73).addBox(-3.5F, -16.95F, -9.8F, 7.0F, 20.0F, 7.0F, new CubeDeformation(0.1F)).texOffs(91, 73)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(2, 33).addBox(-4.0F, -13.0F, 0.0F, 14.0F, 18.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(2, 2)
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 10).addBox(-6.5F, -8.5F, -5.5F, 3.0F, 15.0F, 3.0F, new CubeDeformation(0.1F)),
		...
		PartDefinition RightLeg1 = partdefinition.addOrReplaceChild("RightLeg1",
				CubeListBuilder.create().texOffs(87, 55).addBox(-2.5F, 0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.5F, 10.5F, -11.0F));
		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2",
				CubeListBuilder.create().texOffs(56, 80).addBox(-2.5F, 0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.5F, 10.5F, 11.0F));
		PartDefinition LeftLeg1 = partdefinition.addOrReplaceChild("LeftLeg1",
				CubeListBuilder.create().texOffs(76, 80).addBox(-2.5F, 1.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.5F, 9.5F, -11.0F));
		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2",
				CubeListBuilder.create().texOffs(0, 90).addBox(-2.5F, 0.5F, -2.5F, 5.0F, 13.0F, 5.0F, new CubeDeformation(0.0F)),
