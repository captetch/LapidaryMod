...
public class Modelblue_macaw<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "blue_macaw"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(14, 0).addBox(-1.5F, -2.0F, 2.5F, 3.0F, 4.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 0.6202F, 5.8995F, 1.4399F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -1.5F, -0.75F, 4.0F, 6.0F, 3.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, -5.5F, 1.5F, 0.5236F, 0.0F, 0.0F));

		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(17, 5)
						.addBox(-0.5F, -4.6667F, -2.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
		...
		PartDefinition RightWing = partdefinition.addOrReplaceChild("RightWing", CubeListBuilder.create(),
				PartPose.offset(1.0F, 17.066F, -3.3609F));

		PartDefinition cube_r3 = RightWing.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(12, 6).addBox(-3.0F, -1.5F, -0.75F, 1.0F, 5.0F, 3.0F,
		...
		PartDefinition cube_r4 = RightWing.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(17, 14).addBox(-0.5F, -2.5F, -2.0F, 1.0F, 3.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftWing = partdefinition.addOrReplaceChild("LeftWing", CubeListBuilder.create(),
				PartPose.offset(-2.0F, 17.066F, -3.3609F));
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(20, 9)
						.addBox(-0.5F, 0.75F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-0.5F, 3.75F, -2.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 20.25F, -1.25F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 1)
						.addBox(-0.5F, 2.75F, -2.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(17, 19)
						.addBox(-0.5F, -0.25F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
