...
public class ModelBengal_tiger<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bengal_tiger"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 13)
						.addBox(-2.0F, -1.3333F, -11.7083F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(17, 52)
						.addBox(4.0F, -1.3333F, -7.9583F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-6.0F, -8.2827F, -20.7899F, 12.0F, 11.0F, 20.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 12.0327F, 11.7899F));

		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(44, 0).addBox(-1.0F, -0.25F, -5.5F, 2.0F, 2.0F, 10.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 3.785F, 9.9199F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(32, 31).addBox(-1.0F, 0.25F, -7.0F, 2.0F, 2.0F, 12.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(0.0F, -1.465F, 3.1699F, -0.9599F, 0.0F, 0.0F));

		PartDefinition LeftLeg1 = partdefinition.addOrReplaceChild("LeftLeg1", CubeListBuilder.create().texOffs(0, 47)
				.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg1 = partdefinition.addOrReplaceChild("RightLeg1", CubeListBuilder.create()
				.texOffs(44, 45).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2", CubeListBuilder.create()
				.texOffs(28, 45).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)),
