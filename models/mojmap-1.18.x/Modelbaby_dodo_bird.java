...
public class Modelbaby_dodo_bird<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "baby_dodo_bird"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(18, 12)
						.addBox(-1.0F, -2.625F, -2.375F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(18, 0)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(
				-3.0F, -8.0F, -4.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 11).addBox(-2.0F, 2.5F, -1.25F, 3.0F, 3.0F, 5.0F,
		...
		PartDefinition RightWing = partdefinition.addOrReplaceChild("RightWing", CubeListBuilder.create()
				.texOffs(18, 18).addBox(-2.5F, -1.0F, -2.5F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.01F)),
				PartPose.offset(-1.5F, 17.0F, -1.5F));

		PartDefinition LeftWing = partdefinition.addOrReplaceChild("LeftWing", CubeListBuilder.create().texOffs(11, 14)
				.addBox(1.5F, -1.0F, -2.5F, 1.0F, 4.0F, 5.0F, new CubeDeformation(0.01F)),
				PartPose.offset(1.5F, 17.0F, -1.5F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(2, 11)
						.addBox(-0.5F, 0.75F, -1.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(8, 11)
						.addBox(-1.0F, 3.75F, -3.0F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.5F, 20.25F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 11)
						.addBox(-0.5F, 0.75F, 0.0F, 1.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(12, 11)
						.addBox(-1.0F, 3.75F, -2.0F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
