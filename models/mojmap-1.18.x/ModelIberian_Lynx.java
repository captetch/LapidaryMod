...
public class ModelIberian_Lynx<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "iberian_lynx"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(18, 35)
				.addBox(2.4889F, -3.6078F, -4.4807F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 5)
				.addBox(-1.5111F, -0.6078F, -7.9807F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 8)
				...
				.addBox(1.4889F, -0.6078F, -7.4807F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
				.addBox(-2.5111F, -3.6078F, -6.9807F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5111F, 12.6078F, -3.0193F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(15, 18)
						.addBox(2.25F, -0.75F, 1.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.01F)).texOffs(0, 18)
		...
		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(20, 18).addBox(-2.0F, 0.25F, -3.5F, 4.0F, 4.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0111F, -1.1078F, 0.5193F, -0.6981F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(7, 0)
						.addBox(-1.25F, -2.25F, 1.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.01F)).texOffs(33, 18)
						.addBox(-2.25F, -0.25F, 1.0F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(-1.0111F, -6.1078F, -5.9807F, 0.0F, 0.0F, -0.2618F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, -0.75F, 7.0F, 8.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, 0.25F, 18.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, 12.5F, -11.0F));

		PartDefinition LeftLeg1 = partdefinition.addOrReplaceChild("LeftLeg1", CubeListBuilder.create().texOffs(29, 27)
				.addBox(-0.5F, 0.75F, -2.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(1.9F, 18.0F, -1.9F));

		PartDefinition RightLeg1 = partdefinition.addOrReplaceChild("RightLeg1", CubeListBuilder.create().texOffs(0, 28)
				.addBox(-1.5F, 0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-2.0F, 18.25F, -2.5F));

		PartDefinition LeftLeg2 = partdefinition.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(27, 0)
				.addBox(-1.5F, 0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg2 = partdefinition.addOrReplaceChild("RightLeg2", CubeListBuilder.create()
				.texOffs(17, 27).addBox(-1.5F, 0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
