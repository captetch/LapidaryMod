...
public class ModelOrangutangun<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "orangutangun"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 8)
						.addBox(-2.0F, -1.2667F, -5.6667F, 4.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 25).addBox(-5.0F, -4.75F, -7.0F, 10.0F, 10.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.8702F, 11.2243F, -0.6109F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-5.0F, -4.5F, -6.0F, 10.0F, 11.0F, 14.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -17.293F, -0.4894F, -0.6109F, 0.0F, 0.0F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(48, 0)
						.addBox(4.0F, -3.8041F, -2.8582F, 6.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 17)
		...
		PartDefinition cube_r3 = LeftArm.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(50, 40).addBox(-3.0F, -5.25F, -15.0F, 6.0F, 11.0F, 6.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(7.0F, 16.1959F, 8.2918F, -0.5236F, 0.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(26, 40)
						.addBox(-11.0F, -1.8041F, -2.8582F, 6.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(34, 0)
						.addBox(-10.0F, 16.6959F, -5.4582F, 4.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(26, 25)
		...
		PartDefinition cube_r4 = RightArm.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 41).addBox(-3.0F, -5.25F, -15.0F, 6.0F, 11.0F, 6.0F,
						new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(-8.0F, 18.1959F, 8.2918F, -0.5236F, 0.0F, 0.0F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(0, 58)
				.addBox(-8.5F, 8.4736F, 0.0082F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.5F, 11.5264F, 8.2161F));

		PartDefinition cube_r5 = RightLeg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(40, 57).addBox(-2.5F, -4.0F, -2.0F, 5.0F, 12.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, 1.8534F, -0.9918F, 0.2618F, 0.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(55, 25)
				.addBox(5.5F, 8.4736F, -0.9918F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, 11.5264F, 9.2161F));

		PartDefinition cube_r6 = LeftLeg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(18, 57).addBox(-2.5F, -4.0F, -2.0F, 5.0F, 12.0F, 6.0F,
						new CubeDeformation(0.0F)),
